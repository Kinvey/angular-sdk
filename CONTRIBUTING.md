...
- For bugs and enhancements specific to the JavaScript SDK that are not time critical, please [file a GitHub issue](https://github.com/Kinvey/angular-sdk/issues).
